...
if not shutil.which("ffmpeg"):
    st.error("⚠️ ffmpeg is not installed or not in system PATH. Please install it or bundle ffmpeg.exe.")
else:
    from pydub import AudioSegment
    from io import BytesIO

    # Optionally set the path to ffmpeg manually
    # AudioSegment.converter = "path/to/ffmpeg.exe"  # Uncomment if using bundled ffmpeg
